...
class ControllerShippingBDhlGeoWeight extends Controller {
	private $error = array();
	private $_ext_name = 'b_dhl_geo_weight';
	...
	public function index() {
		...
		foreach ($geo_zones as $geo_zone) {
			...
			if (isset($this->request->post['b_dhl_geo_weight_' . $geo_zone['geo_zone_id'] . '_min'])) {
				$data['b_dhl_geo_weight_' . $geo_zone['geo_zone_id'] . '_min'] = $this->request->post['b_dhl_geo_weight_' . $geo_zone['geo_zone_id'] . '_min'];
			} else {
		...
		$this->response->setOutput($this->load->view('shipping/b_dhl_geo_weight', $data));
	}
