...
<div class="row">
	<div class="col-sm-3"><img class="img-responsive" src="image/logos/Cards.jpg" alt="VISA / MasterCard / Discover accepted"/></div>
</div>
<div class="row">
	<div class="col-sm-3">
...
<!--<script src="https://js.braintreegateway.com/js/braintree-2.32.1.min.js" data-card.cardholder-name="true"></script> -->
...
function send_braintree_payment(nonce) {
	$.ajax({
		url: 'index.php?route=payment/braintree_tlt/send',
		type: 'post',
