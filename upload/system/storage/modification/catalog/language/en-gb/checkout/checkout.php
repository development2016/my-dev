...
// Text
            ...
            $_['text_coupon_success']       = 'Success:Your discount coupon has been successfuly applied to your order!. You will see it in the next checkout step';
            ...
            $_['text_voucher_success']      = 'Success:Your discount gift certificate has been successfuly applied to your order!. You will see it in the next checkout step';
            $_['button_voucher']            = 'Apply Gift Certificate';
            $_['error_empty_voucher']       = 'Warning: Please enter the code of gift certificate to use!';
    
            $_['entry_reward']              = 'Enter your reward points here';
            $_['use_reward']                = 'Use Reward Points (Available %s | Max %s)';
            $_['text_reward_success']       = 'Success:Your reward points discount has been applied to your order!. You will see it in the next checkout step';
            $_['button_reward']             = 'Apply Reward';
