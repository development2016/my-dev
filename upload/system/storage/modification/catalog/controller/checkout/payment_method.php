...
class ControllerCheckoutPaymentMethod extends Controller {
	public function index() {
		...
		if (isset($this->session->data['payment_address'])) {
            ...
            $data['coupon_status'] = $this->config->get('coupon_status') && $this->config->get('apply_checkout_coupon');
            $data['voucher_status'] = $this->config->get('voucher_status') && $this->config->get('apply_checkout_voucher');
            ...
            $data['reward_status'] = ($points && $points_total && $this->config->get('reward_status') && $this->config->get('apply_checkout_reward'));
		...
		$data['text_comments'] = $this->language->get('text_comments');
              ...
              $data['error_empty_coupon'] = $this->language->get('error_empty_coupon');
              
              $data['entry_voucher'] = $this->language->get('entry_voucher');
              $data['use_voucher'] = $this->language->get('use_voucher');
              $data['text_voucher_success'] = $this->language->get('text_voucher_success');
              $data['button_voucher'] = $this->language->get('button_voucher');
              $data['error_empty_voucher'] = $this->language->get('error_empty_voucher');
              ...
              $data['error_empty_reward'] = $this->language->get('error_empty_reward');
